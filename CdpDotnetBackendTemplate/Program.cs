using CdpDotnetBackendTemplate.Example.Endpoints;
using CdpDotnetBackendTemplate.Example.Services;
using CdpDotnetBackendTemplate.Utils;
using CdpDotnetBackendTemplate.Utils.Http;
using CdpDotnetBackendTemplate.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using CdpDotnetBackendTemplate.Config;
using CdpDotnetBackendTemplate.Utils.Logging;
using Serilog;
